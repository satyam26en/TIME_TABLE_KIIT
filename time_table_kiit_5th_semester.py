...
try:
    ...
    print("kaleido is not installed. Please install it using 'pip install -U kaleido'")
    exit()
...
def display_timetable():
    ...
    # Ask the user if they want to download the timetable as an image
    download_choice = input("Do you want to download the timetable as a JPG image? (yes/no): ").strip().lower()
    if download_choice == 'yes':
        img_bytes = fig.to_image(format='jpg')
        with open('timetable.jpg', 'wb') as f:
            f.write(img_bytes)
        print("Timetable has been saved as 'timetable.jpg'")
